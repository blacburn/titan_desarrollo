        ...
        echo $this->miFormulario->formulario($atributos); {
            ...
            echo $this->miFormulario->marcoAgrupacion('inicio', $atributos); {
                ...
                if ($_REQUEST ['mensaje'] == 'nitRep') {
                    ...
                    $mensaje = "No Se Pudo Hacer Registro de Acto administrativo, Por favor revisar que el nit no se encuentre registrado anteriormente <br> Nit: <h4>" . $_REQUEST ['nitRegistro'] . "</h4>" . "<br>Fecha Registro:" . date('Y-m-d');

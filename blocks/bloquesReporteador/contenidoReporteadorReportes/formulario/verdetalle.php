...
class Formulario {
    ...
    function formulario() {
        ...
        $esteCampo = "marcoVerDetalleReporte";
        $atributos ['id'] = $esteCampo;
        ...
        $esteCampo = 'identificadorHistorio';
        $atributos ['id'] = $esteCampo;
        $atributos ['nombre'] = $esteCampo;
        $atributos ['tipo'] = 'text';
        $atributos ['estilo'] = 'jqueryui';
        ...
        if (isset($_REQUEST [$esteCampo])) {
            ...
            $atributos ['valor'] = $resultado[0]['codigo_reporte'];
        }
        ...
        if (isset($_REQUEST [$esteCampo])) {
            ...
            $atributos ['valor'] = "Tipo: " . $resultado[0]['tipo'] . " / Nombre: " . $resultado[0][3];
        }
        $atributos ['deshabilitado'] = true;
        $atributos ['tamanno'] = 50;
        $atributos ['maximoTamanno'] = '';
        ...
        if (isset($_REQUEST [$esteCampo])) {
            ...
            $atributos ['valor'] = $resultado[0]['fecha'];
        }
        $atributos ['deshabilitado'] = true;
        $atributos ['tamanno'] = 50;
        $atributos ['maximoTamanno'] = '';

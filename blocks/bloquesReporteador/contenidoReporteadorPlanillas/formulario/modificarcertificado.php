...
class Formulario {
    ...
    function formulario() {
        ...
        $esteCampo = "marcoPlantillaEditarCertificado";
        $atributos ['id'] = $esteCampo;
...
//        // // ---------------- CONTROL: Input Date --------------------------------------------------------
        ...
        echo "<label class=\"control-label\">Icono Izquierdo Actual</label>";
        ...
        $atributos ["estilo"] = "col-md-6";
        echo $this->miFormulario->division("inicio", $atributos);
        echo "<label class=\"control-label\">Icono Derecho Actual</label>";
        ...
        echo $this->miFormulario->campoImagen($atributos);
        echo $this->miFormulario->division("fin");
        echo "<br><label class=\"control-label\">Actualización de Iconos: Si desea actualizar alguno de los iconos adjunte la nueva imagen y el archivo sera reemplazado, es un procedimiento opcional. </label>";
        $atributos ["id"] = "iconoIzquierdo";
        $atributos ["estilo"] = "col-md-5";
       
        echo $this->miFormulario->division("inicio", $atributos);
        {
            echo "<label class=\"control-label\">Nuevo Icono Izquierdo</label>";
        ...
        echo $this->miFormulario->division("inicio", $atributos);
        {
            echo "<label class=\"control-label\">Nuevo Icono Derecho</label>";
